...
KEYCLOAK_CLIENT_ID = os.getenv("PORTAL_KEYCLOAK_CLIENT_ID", os.getenv("KEYCLOAK_CLIENT_ID", "mcp-client-secure"))
KEYCLOAK_CLIENT_SECRET = os.getenv("PORTAL_KEYCLOAK_CLIENT_SECRET", os.getenv("KEYCLOAK_CLIENT_SECRET", "oORQ1ynZJoiCRduW6aMVqpYq4BFgkPP27f7LMqHbwRUCxviUGzuHGQG9xulwqLXHeRfJASDx1wV3KEsoaT8xyB"))
...
async def verify_portal_token(
    ...
    # Fallback for M2M (client_credentials) tokens:
    try:
