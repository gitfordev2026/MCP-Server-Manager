...
KEYCLOAK_CLIENT_ID = os.getenv("INVENTORY_KEYCLOAK_CLIENT_ID", os.getenv("KEYCLOAK_CLIENT_ID", "mcp-client-secure"))
KEYCLOAK_CLIENT_SECRET = os.getenv("INVENTORY_KEYCLOAK_CLIENT_SECRET", os.getenv("KEYCLOAK_CLIENT_SECRET", "oORQ1ynZJoiCRduW6aMVqpYq4BFgkPP27f7LMqHbwRUCxviUGzuHGQG9xulwqLXHeRfJASDx1wV3KEsoaT8xyB"))
