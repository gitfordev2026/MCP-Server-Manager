...
def create_servers_router(
    ...
    async def sync_server(
        ...
        from app.services.registry.discovery_service import DiscoveredServerSnapshot, DiscoveredToolParameters
        from app.services.registry.registry_sync_service import sync_tools_from_discovery
        import datetime
