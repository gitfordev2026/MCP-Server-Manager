...
const NEXT_PUBLIC_LLM_CHAT_ENABLED = readRequiredEnv(
  process.env.NEXT_PUBLIC_LLM_CHAT_ENABLED,
  "NEXT_PUBLIC_LLM_CHAT_ENABLED"
);
const NEXT_PUBLIC_PLAYGROUND_ENABLED = readRequiredEnv(
  process.env.NEXT_PUBLIC_PLAYGROUND_ENABLED,
