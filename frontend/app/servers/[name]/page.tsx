      ...
      <div className="min-h-screen bg-white dark:bg-slate-900">
        ...
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">Loading server tools...</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-slate-900">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <Card className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 my-18">
            <div className="p-6">
  ...
  if (!serverData) {
    return (
      <div className="min-h-screen bg-white dark:bg-slate-900">
        <Navigation pageTitle="Server Details" />
        <div className="max-w-6xl mx-auto px-4 py-8">
          <p className="text-gray-600 dark:text-gray-300">No server data available</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <Card className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800">
            <div className="p-6">
              <div className="flex items-start justify-between">
                ...
                <div className="px-4 py-2 rounded-lg bg-green-100 dark:bg-green-900/40">
        ...
        <div>
          ...
          {serverData.tools.length === 0 ? (
            <Card className="p-6 text-center bg-gray-50 text-gray-600 dark:bg-gray-800 dark:text-gray-400">
            ...
            <div className="space-y-4">
              {serverData.tools.map((tool) => (
                <div
                  key={tool.name}
                  className={`border rounded-lg transition-all cursor-pointer ${expandedTools.has(tool.name)
                      ? 'bg-green-50 border-green-300 dark:bg-gray-800 dark:border-green-600'
                      : 'bg-white border-gray-200 hover:border-green-300 dark:bg-slate-900 dark:border-gray-700 dark:hover:border-green-600'
                    }`}
                      ...
                      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div className="space-y-4">
                          <div>
                            ...
                            <pre className="p-4 rounded overflow-auto max-h-96 text-xs font-mono bg-gray-100 text-gray-800 border border-gray-200 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700">
