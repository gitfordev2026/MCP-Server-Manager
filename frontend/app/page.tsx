...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 overflow-hidden transition-colors duration-500">
      {/* Elegant background elements */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-80 h-80 bg-amber-400/8 dark:bg-amber-600/15 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-emerald-400/8 dark:bg-emerald-600/15 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-blue-400/5 dark:bg-blue-600/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <main className="pt-24 pb-20 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20 animate-slideInUp">
            <h1 className={`text-6xl md:text-7xl font-bold mb-4 transition-colors duration-500 text-slate-900 dark:text-slate-100`}>
              Server Management
            </h1>
            <p className={`text-lg mb-2 max-w-2xl mx-auto font-normal transition-colors duration-500 text-slate-500 dark:text-slate-400`}>
              Centralized control for all your MCP servers
            </p>
            <p className={`text-sm max-w-2xl mx-auto transition-colors duration-500 text-slate-400`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
            ...
            <div className="group relative animate-slideInUp" style={{ animationDelay: '0.1s' }}>
              ...
              <div className={`relative border rounded-xl p-8 hover:border-slate-300 dark:border-slate-600/80 transition-all duration-300 shadow-sm hover:shadow-lg hover:-translate-y-1 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700/80`}>
                <div className="flex items-start justify-between mb-6">
                  <div className="flex-1">
                    <p className={`text-xs font-semibold uppercase tracking-wider transition-colors duration-500 text-slate-500 dark:text-slate-400`}>Active Servers</p>
                    <h3 className={`text-5xl font-bold mt-3 group-hover:text-amber-600 transition-colors duration-300 text-slate-900 dark:text-slate-100`}>
                      {statusSummary.alive}
                    </h3>
                  </div>
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center border transition-all duration-300 bg-gradient-to-br from-slate-100 to-slate-50 border-slate-300 dark:border-slate-600/60 group-hover:bg-gradient-to-br group-hover:from-amber-50 group-hover:to-amber-100 group-hover:border-amber-300 dark:border-amber-700/60`}>
                    <svg className={`w-6 h-6 transition-colors duration-300 group-hover:text-amber-600 text-slate-700 dark:text-slate-300`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className={`pt-4 border-t transition-colors duration-500 border-slate-100 text-slate-600 dark:text-slate-400`}>
            ...
            <div className="group relative animate-slideInUp" style={{ animationDelay: '0.2s' }}>
              ...
              <div className={`relative border rounded-xl p-8 hover:border-slate-300 dark:border-slate-600/80 transition-all duration-300 shadow-sm hover:shadow-lg hover:-translate-y-1 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700/80`}>
                <div className="flex items-start justify-between mb-6">
                  <div className="flex-1">
                    <p className={`text-xs font-semibold uppercase tracking-wider transition-colors duration-500 text-slate-500 dark:text-slate-400`}>System Status</p>
                    <h3 className={`text-4xl font-bold mt-3 group-hover:text-emerald-600 transition-colors duration-300 text-slate-900 dark:text-slate-100`}>
                  ...
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center border transition-all duration-300 bg-gradient-to-br from-slate-100 to-slate-50 border-slate-300 dark:border-slate-600/60 group-hover:bg-gradient-to-br group-hover:from-emerald-50 group-hover:to-emerald-100 group-hover:border-emerald-300/60`}>
                    <svg className={`w-6 h-6 transition-colors duration-300 group-hover:text-emerald-600 text-slate-700 dark:text-slate-300`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="group relative animate-slideInUp" style={{ animationDelay: '0.3s' }}>
              ...
              <div className={`relative border rounded-xl p-8 hover:border-slate-300 dark:border-slate-600/80 transition-all duration-300 shadow-sm hover:shadow-lg hover:-translate-y-1 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700/80`}>
                <div className="flex items-start justify-between mb-6">
                  <div className="flex-1">
                    <p className={`text-xs font-semibold uppercase tracking-wider transition-colors duration-500 text-slate-500 dark:text-slate-400`}>Uptime</p>
                    <h3 className={`text-4xl font-bold mt-3 group-hover:text-blue-600 transition-colors duration-300 text-slate-900 dark:text-slate-100`}>
                      {averageLatency === null ? '--' : `${averageLatency}ms`}
                    </h3>
                  </div>
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center border transition-all duration-300 bg-gradient-to-br from-slate-100 to-slate-50 border-slate-300 dark:border-slate-600/60 group-hover:bg-gradient-to-br group-hover:from-blue-50 group-hover:to-blue-100 group-hover:border-blue-300 dark:border-blue-700/60`}>
                    <svg className={`w-6 h-6 transition-colors duration-300 group-hover:text-blue-600 text-slate-700 dark:text-slate-300`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="animate-slideInUp" style={{ animationDelay: '0.4s' }}>
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className={`text-3xl font-bold mb-2 transition-colors duration-500 text-slate-900 dark:text-slate-100`}>Connected Servers</h2>
                <p className={`text-sm transition-colors duration-500 text-slate-500 dark:text-slate-400`}>
              ...
              <div className="flex items-center justify-center py-20">
                <div className="text-center">
                  <div className="inline-block">
                    <div className={`w-16 h-16 border-4 rounded-full animate-spin border-amber-300 dark:border-amber-700 border-t-amber-600`}></div>
                  </div>
                  <p className={`mt-4 transition-colors duration-500 text-slate-600 dark:text-slate-400`}>Loading servers...</p>
                </div>
              </div>
            ) : error ? (
              <div className={`rounded-2xl p-8 text-center border bg-red-50 dark:bg-red-900/30 border-red-200`}>
                <p className={`font-medium transition-colors duration-500 text-red-600`}>⚠️ {error}</p>
              </div>
            ) : servers.length === 0 ? (
              <div className={`rounded-xl p-16 text-center border bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700`}>
                <div className={`text-5xl mb-6 opacity-60 `}>🖥️</div>
                <h3 className={`text-xl font-bold mb-2 transition-colors duration-500 text-slate-900 dark:text-slate-100`}>No Servers Connected</h3>
                <p className={`mb-8 max-w-md mx-auto transition-colors duration-500 text-slate-500 dark:text-slate-400`}>Start by registering your first MCP server to begin monitoring and management</p>
                <Link href="/register-server">
                ...
                {servers.map((server, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`relative border rounded-xl overflow-hidden hover:border-slate-300 dark:border-slate-600/80 transition-all duration-300 h-full shadow-sm hover:shadow-lg hover:-translate-y-1 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700/80`}>
                        ...
                        <div className="p-6">
                          <div className="flex items-start justify-between mb-4">
                            <div className={`w-10 h-10 rounded-lg flex items-center justify-center border transition-all duration-300 bg-gradient-to-br from-slate-100 to-slate-50 border-slate-300 dark:border-slate-600/60 group-hover:from-amber-50 group-hover:to-amber-100 group-hover:border-amber-300 dark:border-amber-700/60`}>
                              <svg className={`w-5 h-5 transition-colors duration-300 group-hover:text-amber-600 text-slate-700 dark:text-slate-300`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                              </svg>
                            </div>
                            <div className={`flex items-center gap-2 px-3 py-1 rounded-full border ${isAlive ? 'bg-emerald-50 border-emerald-200 text-emerald-700 dark:bg-emerald-900/30 dark:border-emerald-500 dark:text-emerald-300' : 'bg-amber-50 border-amber-200 text-amber-700 dark:bg-amber-900/30 dark:border-amber-500/30 dark:text-amber-300'}`}>
                          ...
                          <h3 className={`text-lg font-bold mb-1 truncate line-clamp-1 group-hover:text-amber-600 transition-colors duration-300 text-slate-900 dark:text-slate-100`}>{server.name}</h3>
                          <p className={`text-xs font-mono mb-2 truncate opacity-75 text-slate-500 dark:text-slate-400`}>{server.url.split('//')[1] || server.url}</p>
                          <div className={`text-xs mb-4 space-y-1 text-slate-500 dark:text-slate-400`}>
                          ...
                          <div className="flex gap-2">
                            <Link href={`/servers/${encodeURIComponent(server.name)}`} className="flex-1">
                              <button className={`cursor-pointer w-full py-2 rounded-lg font-medium transition-all duration-200 text-sm border bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:border-slate-600`}>
                                View Tools
                              </button>
                            </Link>
                            <Link href={`/api-explorer?url=${encodeURIComponent(server.url)}&name=${encodeURIComponent(server.name)}`}>
                              <button className={`cursor-pointer px-3 py-2 rounded-lg transition-all duration-200 text-sm border font-medium bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:border-slate-600`}>
                                APIs
                              </button>
                            </Link>
                          </div>
          ...
          <div className="animate-slideInUp mt-16" style={{ animationDelay: '0.5s' }}>
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className={`text-3xl font-bold mb-2 transition-colors duration-500 text-slate-900 dark:text-slate-100`}>Registered Applications</h2>
                <p className={`text-sm transition-colors duration-500 text-slate-500 dark:text-slate-400`}>
            ...
            {apps.length === 0 ? (
              <div className={`rounded-xl p-16 text-center border bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700`}>
                ...
                <h3 className={`text-xl font-bold mb-2 transition-colors duration-500 text-slate-900 dark:text-slate-100`}>No Applications Registered</h3>
                <p className={`mb-8 max-w-md mx-auto transition-colors duration-500 text-slate-500 dark:text-slate-400`}>Start by registering your first application base URL to access its API endpoints</p>
                <Link href="/register-app">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className={`relative border rounded-xl overflow-hidden hover:border-slate-300 dark:border-slate-600/80 transition-all duration-300 h-full shadow-sm hover:shadow-lg hover:-translate-y-1 bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700/80`}>
                          ...
                          <div className="p-6">
                            <div className="flex items-start justify-between mb-4">
                              <div className={`w-10 h-10 rounded-lg flex items-center justify-center border transition-all duration-300 bg-gradient-to-br from-slate-100 to-slate-50 border-slate-300 dark:border-slate-600/60 group-hover:from-blue-50 group-hover:to-blue-100 group-hover:border-blue-300 dark:border-blue-700/60`}>
                                <span className="text-lg">🔌</span>
                              </div>
                              <div className={`flex items-center gap-2 px-3 py-1 rounded-full border ${isAlive ? 'bg-cyan-50 border-cyan-200 text-cyan-700 dark:bg-cyan-900/30 dark:border-cyan-500/30 dark:text-cyan-300' : 'bg-amber-50 border-amber-200 text-amber-700 dark:bg-amber-900/30 dark:border-amber-500/30 dark:text-amber-300'}`}>
                                <span className={`w-2 h-2 rounded-full animate-pulse ${isAlive ? 'bg-cyan-500' : 'bg-amber-500'}`}></span>
                                <span className="text-xs font-semibold">{isAlive ? 'Alive' : 'Down'}</span>
                              </div>
                            </div>

                            <h3 className={`text-lg font-bold mb-1 truncate line-clamp-1 group-hover:text-blue-600 transition-colors duration-300 text-slate-900 dark:text-slate-100`}>{app.name}</h3>
                            <p className={`text-xs font-mono mb-2 truncate opacity-75 text-slate-500 dark:text-slate-400`}>{app.url.split('//')[1] || app.url}</p>
                            <div className={`text-xs mb-2 space-y-1 text-slate-500 dark:text-slate-400`}>
                              <p>{health ? `${health.latency_ms} ms latency` : 'Waiting for status...'}</p>
                              <p>
                                {health && health.status === 'alive'
                            ...
                            <p className={`text-xs font-mono mb-6 truncate opacity-60 text-slate-400`}>
                              {normalizeOpenApiUrl(app.url, app.openapi_path)}
                            </p>

                            <div className="flex gap-2">
                              <button className={`cursor-pointer flex-1 py-2 rounded-lg font-medium transition-all duration-200 text-sm border bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:border-slate-600`}>
                                View APIs
                              </button>
                              <button className={`cursor-pointer px-3 py-2 rounded-lg transition-all duration-200 text-sm border font-medium bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:border-slate-600`}>
                                •••
