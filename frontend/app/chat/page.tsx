    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-slate-50 to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex flex-col overflow-hidden">
      ...
      <main className="flex-1 flex flex-col pt-24 pb-4 relative z-10">
        <div className="max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col h-full">
          {/* Messages Container */}
          <div className="flex-1 bg-white dark:bg-slate-900/70 backdrop-blur-xl border border-amber-300 dark:border-amber-700/50 rounded-2xl overflow-hidden flex flex-col shadow-lg shadow-amber-200/30">
              ...
              {loading && (
                <div className="flex justify-start animate-slideInLeft">
                  <div className="flex gap-3">
                    ...
                    <div className="bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 px-5 py-4 rounded-2xl rounded-bl-none border border-amber-300 dark:border-amber-700/50 shadow-md">
            ...
            {/* Input Area */}
            <div className="border-t border-amber-300 dark:border-amber-700/50 bg-white dark:bg-slate-900/70 backdrop-blur-xl p-4 sm:p-6 shadow-lg">
              <form onSubmit={handleSendMessage} className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-5 py-3 border border-amber-300 dark:border-amber-700/50 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 placeholder-slate-400 transition-all duration-300 hover:border-amber-400/70"
                  disabled={loading}
                />
                <button
                  type="submit"
