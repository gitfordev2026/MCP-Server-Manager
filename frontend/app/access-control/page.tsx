      ...
      <main className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
        ...
        {isLoading && (
          <div className="flex items-center justify-center py-20">
            ...
            <span className="ml-3 text-slate-600 dark:text-slate-400 font-medium">Loading access policies...</span>
          </div>
        )}

        {!isLoading && owners.length === 0 && (
          <div className="bg-white dark:bg-slate-900/85 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-2xl p-8 text-center text-slate-600 dark:text-slate-400 shadow-lg">
        ...
        {!isLoading && owners.length > 0 && (
          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900/85 backdrop-blur-sm shadow-lg p-6">
