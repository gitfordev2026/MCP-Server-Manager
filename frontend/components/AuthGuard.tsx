...
export default function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  if (maintenanceActive && !isSecretAdminRoute && !isAdminUser) {
    return (
      <div className="maint-wrapper">
        ...
        {/* Top Header - Aligned to max-w-560px for perfect column alignment */}
        ...
        {/* Footer - Aligned to max-w-560px for perfect column symmetry */}
  ...
  // 1. Render public pages immediately without blocking
  if (isPublicPath) {
    return <>{children}</>;
  }
