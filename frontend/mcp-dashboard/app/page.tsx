          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className="flex-1">
                    ...
                    <h3 className={`text-4xl font-bold mt-3 group-hover:text-emerald-600 transition-colors duration-300 ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>
                      <span className="inline-flex items-center gap-2"><span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span>Online</span>
                    </h3>
                  </div>
            ...
            <div className="group relative animate-slideInUp" style={{ animationDelay: '0.3s' }}>
              ...
              <div className={`relative border rounded-xl p-8 hover:border-slate-300/80 transition-all duration-300 shadow-sm hover:shadow-lg hover:-translate-y-1 ${isDark ? 'bg-slate-800 border-slate-700/80 hover:border-slate-600/80' : 'bg-white border-slate-200/80'}`}>
                ...
                <div className={`pt-4 border-t transition-colors duration-500 ${isDark ? 'border-slate-700 text-slate-400' : 'border-slate-100 text-slate-600'}`}>
                  <p className="text-sm">Last 30 days average</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="animate-slideInUp" style={{ animationDelay: '0.4s' }}>
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className={`text-sm transition-colors duration-500 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Manage and monitor your MCP server instances</p>
              </div>
                    ...
                    <div className={`relative border rounded-xl overflow-hidden hover:border-slate-300/80 transition-all duration-300 h-full shadow-sm hover:shadow-lg hover:-translate-y-1 ${isDark ? 'bg-slate-800 border-slate-700/80 hover:border-slate-600/80' : 'bg-white border-slate-200/80'}`}>
                      ...
                      <div className="p-6">
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className={`flex items-center gap-2 px-3 py-1 rounded-full border ${isDark ? 'bg-emerald-900/30 border-emerald-500/30 text-emerald-300' : 'bg-emerald-50 border-emerald-200 text-emerald-700'}`}>
                        ...
                        <p className={`text-xs font-mono mb-6 truncate opacity-75 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>{server.url.split('//')[1] || server.url}</p>
          ...
          <div className="animate-slideInUp mt-16" style={{ animationDelay: '0.5s' }}>
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className={`text-sm transition-colors duration-500 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>Manage your application base URLs and API endpoints</p>
              </div>
                      ...
                      <div className={`relative border rounded-xl overflow-hidden hover:border-slate-300/80 transition-all duration-300 h-full shadow-sm hover:shadow-lg hover:-translate-y-1 ${isDark ? 'bg-slate-800 border-slate-700/80 hover:border-slate-600/80' : 'bg-white border-slate-200/80'}`}>
                        ...
                        <div className="p-6">
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <div className={`flex items-center gap-2 px-3 py-1 rounded-full border ${isDark ? 'bg-cyan-900/30 border-cyan-500/30 text-cyan-300' : 'bg-cyan-50 border-cyan-200 text-cyan-700'}`}>
