    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center gap-4">
        ...
        <div className="flex gap-2 md:gap-3 items-center flex-wrap justify-end">
          <Link href="/">
            <Button
              className={`px-4 py-2 rounded-lg text-sm md:text-base font-bold transition-all duration-300 hover:scale-105 ${
                pathname === '/'
          ...
          <Link href="/register-server">
            <Button
              className={`px-4 py-2 rounded-lg text-sm md:text-base font-bold transition-all duration-300 hover:scale-105 ${
                pathname === '/register-server' || pathname.includes('/servers/')
          ...
          <Link href="/register-app">
            <Button
              className={`px-4 py-2 rounded-lg text-sm md:text-base font-bold transition-all duration-300 hover:scale-105 ${
                pathname === '/register-app' || pathname.includes('/register-app/')
